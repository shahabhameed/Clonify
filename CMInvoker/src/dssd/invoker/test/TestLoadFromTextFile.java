...
public void Open_InfileStructure()
{
...
public void check_parsing_FileClusters() throws NumberFormatException, IOException{
	...
	String id, l, m, fid, sl, sc, el, ec, filePath = null;
...
public void checkFilesize_zero() {
...
public void checkFilesize_working() {
DBLoaderFromTextFiles dbt = new DBLoaderFromTextFiles();
