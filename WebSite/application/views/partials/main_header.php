...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?= asset_url('plugins/jqwidgets/styles/jqx.base.css') ?>" type="text/css" rel="stylesheet" />
        <link href="<?= asset_url('plugins/files/elfinder/elfinder.css') ?>" rel="stylesheet" type="text/css"  >
