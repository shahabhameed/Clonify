                            ...
                            <form method="post" accept-charset="utf-8" action="<?php echo base_url(); ?>index.php/load_results/update_results" >
                                ...
                                <div class="form-group col-lg-12">
                                    <div class="col-lg-offset-0 col-lg-9">
                                        <button type="submit" class="btn btn-info pull-left marginR10 marginT10" style="width:120px">Save Changes</button>
                                        <button type="button" onclick="location.href = '<?php echo base_url(); ?>'" class="btn btn-danger col-lg-1 marginT10" style="width:120px">Cancel</button>
