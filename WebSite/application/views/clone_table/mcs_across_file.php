            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Select * From MCS Across File List Where</h4>
                    </div>
                ...
                <div class="row scs_instance_list" id="scs_instance_list_<?php echo $mcs_crossfile_id; ?>">
                    <div class="col-md-12">
                        <div class="panel panel-default gradient">
                            ...
                            <div class="panel-body noPad clearfix">
                                <table cellpadding="0" cellspacing="0" border="0" class="responsive dynamicTableMcsAcross display table table-bordered" width="100%">
                                    <thead>
                                        <tr>
                                            <th>No.</th>                        
                                            <th>GID</th>
