...
(function (e) {
    ...
    var a = function (f) {
        ...
        var g = e.map(f, function (i) {
          var height = i.rows / 1.5;
            return e('<li><a style="display: inline-block; height: '+height+'px" rows="'+ i.rows +'" line_num="'+ i.lineNum +'" href="' + i.href + '">' + i.text + "</a></li>")[0];
        });
    ...
    window.FlexibleNav = function (_container, g) {
        ...
        f.update = function (_container) {
            ...
            e.each(h, function (m, n) {
              ...
              var top = 0;
              if (nav_previous_margin > 0){
                top = ((line_num * height_per_line) - 20) - nav_previous_margin;
              }else{
                top = (line_num * height_per_line) - 20;
              }
              nav_previous_margin = top + nav_previous_margin;              
