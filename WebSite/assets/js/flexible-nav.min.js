(function (e) {
    ...
    var a = function (f) {
        ...
        var g = e.map(f, function (i) {
            return e('<li><a rows="'+ i.rows +'" line_num="'+ i.lineNum +'" href="' + i.href + '"><div></div>' + i.text + "</a></li>")[0];
        });
    ...
    window.FlexibleNav = function (_container, g) {
        ...
        f.update = function (_container) {
            ...
            e.each(h, function (m, n) {
              ...
              var top = (line_num * height_per_line) - previous_margin;
              previous_margin = top;              
              n.node.parent().css("margin-top", top + "px");
              if ($(n.node + " div").length > 0){
                alert("d");
                $(n.node + " div").css("height", height);
              }
            });            
            e.each(h, function (m, n) {
