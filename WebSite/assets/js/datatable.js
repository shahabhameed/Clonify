...
$(document).ready(function() {
    ...
    if ($('table').hasClass('dynamicTableMcs')) {
        $('.dynamicTableMcs').dataTable({
            ...
            {column_number : 3,filter_container_id : "sccnumberfilter", filter_type: "range_number_slider"}
        ]);
        $('.dataTables_length select').uniform();
        $('.dataTables_paginate > ul').addClass('pagination');
        $('.dataTables_filter>label>input').addClass('form-control');
    ...
    if ($('table').hasClass('dynamicTableMcsAcross')) {
        $('.dynamicTableMcsAcross').dataTable({
            "sDom": "<'row'<'col-lg-6'><'col-lg-6'f>r>t<'row'<'col-lg-6'i l><'col-lg-6'p>>",
            "sPaginationType": "bootstrap",
            "bJQueryUI": false,
            "bAutoWidth": false,
    ...
    if ($('table').hasClass('dynamicTableMethodByFileSecondary')) {
        $('.dynamicTableMethodByFileSecondary').dataTable({
            "sDom": "<'row'<'col-lg-6'><'col-lg-6'f>r>t<'row'<'col-lg-6'i l><'col-lg-6'p>>",
            "sPaginationType": "bootstrap",
            "bJQueryUI": false,
            "bAutoWidth": false,
    ...
    if ($('table').hasClass('dynamicTableSccByMethod')) {
        $('.dynamicTableSccByMethod').dataTable({
            ...
            {column_number : 4,filter_container_id : "gidnumberfilter"},
            {column_number : 3,filter_container_id : "didnumberfilter"},
            {column_number : 2,filter_container_id : "fidnumberfilter"},
            {column_number : 7,filter_container_id : "sccnumberfilter", filter_type: "range_number_slider"}
        ]);
